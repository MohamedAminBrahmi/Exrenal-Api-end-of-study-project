...
public class ServiceMapSearch {
	...
	public SearchRequest SearchRQ(FlightSearchModel model) {
		...
		request.setEndUserBrowserAgent("Mozilla/5.0(Windows NT 6.1; Win64; x64) AppleWebKit/537.36(KHTML, likeGecko) Chrome/70.0.3538.110 Safari/537.36");
		...
		if(model.getTypeSearch()==1 && model.getDepartVol1() != null && model.getDestinationVol1()!=null) {
			Segment seg=new Segment(model.getDepartVol1(),model.getDestinationVol1(),model.getDepartleVol1(),model.getRetourleVol1());
			segments.add(seg);
		}
		if(model.getTypeSearch()==2 && model.getDepartVol1() != null && model.getDestinationVol1()!=null
			...
			Segment seg=new Segment(model.getDepartVol1(),model.getDestinationVol1(),model.getDepartleVol1(),model.getDepartleVol2());
			segments.add(seg);
			Segment seg1=new Segment(model.getDepartVol2(),model.getDestinationVol2(),model.getDepartleVol2(),model.getRetourleVol1());
			segments.add(seg1);
		}
		if(model.getTypeSearch()==3 && model.getDepartVol1() != null && model.getDestinationVol1()!=null
				&& model.getDepartVol2() != null && model.getDestinationVol2()!=null
				&& model.getDepartVol3() != null && model.getDestinationVol3()!=null) {
			Segment seg=new Segment(model.getDepartVol1(),model.getDestinationVol1(),model.getDepartleVol1(),model.getDepartleVol2());
			segments.add(seg);
			Segment seg1=new Segment(model.getDepartVol2(),model.getDestinationVol2(),model.getDepartleVol2(),model.getDepartleVol3());
			segments.add(seg1);
			Segment seg2=new Segment(model.getDepartVol3(),model.getDestinationVol3(),model.getDepartleVol3(),model.getRetourleVol1());
			segments.add(seg2);
		};
