...
public class OutWard {
	...
	public OutWard(String code, int description, double price, int weight, String text, int wayTypeField, String origin,
	...
	public String toString() {
		return "OutWard [code=" + code + ", description=" + description + ", price=" + price + ", weight=" + weight
